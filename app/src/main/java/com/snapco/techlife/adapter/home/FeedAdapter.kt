...
class FeedAdapter : RecyclerView.Adapter<FeedHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeedHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.techlife_feed, parent, false)
...
class FeedHolder(itemView: View) : ViewHolder(itemView){
    ...
    val userNamePoster : TextView = itemView.findViewById(R.id.username_id)
    val userNameCaption : TextView = itemView.findViewById(R.id.status_id)

    val userPosterImage : CircleImageView = itemView.findViewById(R.id.userProfile_id)
    val feedImage : ImageView = itemView.findViewById(R.id.imageView)
    val time: TextView = itemView.findViewById(R.id.date_id)
    val likecount: TextView = itemView.findViewById(R.id.comment_count_id)
