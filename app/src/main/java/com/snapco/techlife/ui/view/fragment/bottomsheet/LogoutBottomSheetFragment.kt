 ...
 * Use the [LogoutBottomSheetFragment.newInstance] factory method to
...
class LogoutBottomSheetFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LogoutBottomSheetFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String ,param2: String) =
            LogoutBottomSheetFragment().apply {
